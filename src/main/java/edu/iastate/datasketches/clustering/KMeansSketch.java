...
public class KMeansSketch {
	 ...
	 * @return
	 */
	public List<Point> randomCenters(final List<Point> pointList, int m, Random random) {
     ...
     */
    public List<Point> seeding(final List<Point> pointList, int m, Random random) {
